...
<body>
    <div class="container">
        ...
        <a href="{{ route('pengumuman.tambah-data') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Pasien Baru</a>
