                        ...
                        <form id="form-login" action="{{ route('pengumuman.buat-data') }}" method="post">
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg" name="Nama" type="text"
                                       placeholder="Nama" value="{{ old('Nama') }}" autofocus required>
                            </div>
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg" name="Umur" type="text"
                                       placeholder="Umur" value="{{ old('Umur') }}" autofocus required>
                            </div>
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg" name="Penyakit" type="text"
                                       placeholder="Penyakit" value="{{ old('Penyakit') }}" autofocus required>
                            </div>
